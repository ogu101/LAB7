...
//---------------------------------------------------------------------------------------------------------------------
     ...
     */
    private static boolean isTeethValid (String teethPerRow){
...
//---------------------------------------------------------------------------------------------------------------------
     ...
     */
    private static String diplayMenuAndGetUserMenuChoice(){
...
//---------------------------------------------------------------------------------------------------------------------
     ...
     * @param memberNamesList List  of family member names
     */
    private static void printDentalRecords(char [][][] dentalRecords, String [] memberNamesList) {
...
// ---------------------------------------------------------------------------------------------------------------------
     ...
     * @param memberNamesList List of family member names
     */
    private static void extractTooth(char[][][] dentalRecords, String [] memberNamesList ){
